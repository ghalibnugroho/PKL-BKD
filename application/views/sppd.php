                    ...
                    <div class="form-group">
                      <div class="row">
                        <div class="col-sm-3">
                          ...
                          <input type="text" id="tempat_berangkat" name="tempat_berangkat" class="form-control sc-input-required" value="<?php echo $li->TMP_BERANGKAT ?>" placeholder="Tempat Berangkat">
                        </div>
                        <div class="col-sm-3">
                          <label>Tempat Tujuan</label>
                          <input type="text" name="tempat_tujuan" class="form-control sc-input-required" value="<?php echo $li->TMP_TUJUAN ?>" placeholder="Tempat Tujuan">
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <div class="row">
                        <div class="col-sm-4">
                          ...
                          <input type="text" name="instansi" class="form-control sc-input-required" placeholder="Instansi Tujuan" value="<?php echo $li->INSTANSI ?>">
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
